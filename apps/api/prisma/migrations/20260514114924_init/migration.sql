...
-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('enroll', 'talk_to_expert', 'homepage');

-- CreateEnum
CREATE TYPE "PaymentPurpose" AS ENUM ('enrollment', 'wallet_topup');
...
CREATE TABLE "Course" (
    ...
    "rating" DOUBLE PRECISION NOT NULL DEFAULT 4.5,
    "accreditation" TEXT NOT NULL DEFAULT 'UGC Approved',
    "tags" TEXT[],
...
CREATE TABLE "Payment" (
    ...
    "purpose" "PaymentPurpose" NOT NULL DEFAULT 'enrollment',
...
-- CreateIndex
CREATE INDEX "Course_specialization_idx" ON "Course"("specialization");

-- CreateIndex
CREATE INDEX "Course_fee_idx" ON "Course"("fee");
